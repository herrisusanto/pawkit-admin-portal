...
export declare type BreedCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: BreedCreateFormInputValues) => BreedCreateFormInputValues;
    onSuccess?: (fields: BreedCreateFormInputValues) => void;
    onError?: (fields: BreedCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: BreedCreateFormInputValues) => BreedCreateFormInputValues;
    onValidate?: BreedCreateFormValidationValues;
} & React.CSSProperties>;
export default function BreedCreateForm(props: BreedCreateFormProps): React.ReactElement;
