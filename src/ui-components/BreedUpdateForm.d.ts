...
import { Breed } from "../api/graphql/API.ts";
...
export declare type BreedUpdateFormProps = React.PropsWithChildren<{
    ...
    name?: string;
    breed?: Breed;
    onSubmit?: (fields: BreedUpdateFormInputValues) => BreedUpdateFormInputValues;
    onSuccess?: (fields: BreedUpdateFormInputValues) => void;
    onError?: (fields: BreedUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: BreedUpdateFormInputValues) => BreedUpdateFormInputValues;
    onValidate?: BreedUpdateFormValidationValues;
} & React.CSSProperties>;
export default function BreedUpdateForm(props: BreedUpdateFormProps): React.ReactElement;
