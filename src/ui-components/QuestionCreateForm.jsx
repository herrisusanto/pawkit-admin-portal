...
import { createQuestion } from "../api/graphql/mutations";
...
export default function QuestionCreateForm(props) {
  ...
  const resetStateValues = () => {
    setServiceCategory(initialValues.serviceCategory);
    setQuestionString(initialValues.questionString);
    setQuestionType(initialValues.questionType);
    setFollowUpQuestionIds(initialValues.followUpQuestionIds);
